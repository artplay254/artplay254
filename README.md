...
<!-- BANNER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=5E81AC,81A1C1&height=200&section=header&text=Artem%20Semenihin&fontSize=52&fontColor=ECEFF4&fontAlignY=38&desc=Builder.%20Learner.%20Human.&descAlignY=60&descColor=D8DEE9&animation=fadeIn" width="100%"/>

<!-- TYPING SVG -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=17&pause=1000&color=81A1C1&center=true&vCenter=true&width=600&lines=Full+Stack+Developer+in+progress;Arch+Linux+%2F+KDE+Plasma+daily+driver;Parkour+%7C+Calisthenics+%7C+Cold+showers+at+5+AM;Building+hard+things+on+purpose." alt="Typing SVG" /></a>
...
[![WakaTime](https://wakatime.com/badge/user/72b1c550-60d3-405b-ac99-8959268a85f2.svg?style=flat-square)](https://wakatime.com/@artplay254)
![5AM](https://img.shields.io/badge/🕔_5_AM-Cold_Shower-5E81AC?style=flat-square)
![Age](https://img.shields.io/badge/Age-15-81A1C1?style=flat-square)
![Location](https://img.shields.io/badge/📍_Lipetsk-Russia-4C566A?style=flat-square)
![Journey start](https://img.shields.io/badge/Journey_Started-March_2026-A3BE8C?style=flat-square)
...
  born:       "December 7, 2010 — Lipetsk, Russia",
  grade:      "9th grade (2025–2026)",
  role:       "Fullstack Dev in training",
  os:         "Arch Linux + KDE Plasma (1+ year daily driver)",
...
## 🗺 The Quest — Full Stack Developer Path

> *Started: March 1, 2026 · Goal: ~2032–2035*

```
[ LEVEL 1 ] ✅  Foundations          HTML · CSS · JavaScript · Git
[ LEVEL 2 ] 🔨  Frontend Dev         React · TypeScript · Responsive Design
[ LEVEL 3 ] ⬜  Backend Dev          Node.js · Express · REST APIs
[ LEVEL 4 ] ⬜  Databases            SQL · PostgreSQL · Firebase
[ LEVEL 5 ] ⬜  Fullstack Projects   Deploy real apps · Build portfolio
[ LEVEL 6 ] ⬜  Freelance / Remote   First paid work · Remote job
[ LEVEL 7 ] ⬜  School Done          Finish 9–11 grade · Exams passed ✓
...
Since I was 12, I've been in a permanent experimenting mode. Blender, Arduino, parkour, calisthenics, martial arts, BMX tricks, Linux, cold showers, 5 AM mornings — I try everything, and I keep what makes me better. I don't like easy. When there's a hard task in the room, I want it.

I value depth over noise. I'd rather discuss a crazy universe theory at 1 AM than scroll TikTok for three hours. I train my body, I train my mind, and I try not to waste either.

My inspirations: **Bryan Johnson** (longevity & optimization), **Wim Hof** (cold exposure & breathing), **Magnus Midtbø** (climbing & discipline), **Stan Browney** (calisthenics), **Nick Pro** (parkour), **Sergio Nee** — and of course, **Dragon Ball**, which has been my philosophy since before I could articulate it.

I speak Russian natively and have pushed my English to B2–C1 through full immersion — I think in English, dream in English, and write in English. Because the world I want to live in speaks English.

**What I don't respect:** laziness dressed as depression, TikTok brain, fake friendships, weak character. Life is short and hard. Be real or be gone.
